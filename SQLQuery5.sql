...
insert into TBLFACTURA( DtmFecha, IdCliente, IdEmpleado, NumDescuento, NumImpuesto ,NumValorTotal,IdEstado,DtmFechaModifica, StrUsuarioModifica)
 ...
 update TBLFACTURA set DtmFecha=@DtmFecha,IdCliente= @IdCliente,IdEmpleado= @IdEmpleado,NumDescuento= @NumDescuento,NumImpuesto= @NumImpuesto ,NumValorTotal=@NumValorTotal,IdEstado=@IdEstado,DtmFechaModifica=@DtmFechaModifica, StrUsuarioModifica= @StrUsuarioModifica  where IdFactura=@IdFactura
GO
...
insert into TBLSEGURIDAD(IdEmpleado,StrUsuario,StrClave,DtmFechaModifica,StrUsuarioModifico)
 ...
 update TBLSEGURIDAD set StrUsuario=@StrUsuario,StrClave=@StrClave,DtmFechaModifica=@DtmFechaModifica,StrUsuarioModifico=@StrUsuarioModifico where IdEmpleado=@IdEmpleado
GO
