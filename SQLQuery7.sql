-- 1. BORRAMOS LOS DATOS EXISTENTES PARA EMPEZAR DE CERO
-- (El orden es importante para no violar las relaciones entre tablas)
...
-- 2. INSERTAMOS LA LISTA COMPLETA Y CORRECTA DE DATOS
...
INSERT [dbo].[TBLCLIENTES] ([IdCliente], [StrNombre], [NumDocumento], [StrDireccion], [StrTelefono], [StrEmail], [DtmFechaModifica], [StrUsuarioModifico]) VALUES (1022, N'pedro paramo', 7777777, N'calle', N'12345', N'javi@javi.com', CAST(N'2020-09-02T00:00:00.000' AS DateTime), N'Javier')
INSERT [dbo].[TBLCLIENTES] ([IdCliente], [StrNombre], [NumDocumento], [StrDireccion], [StrTelefono], [StrEmail], [DtmFechaModifica], [StrUsuarioModifico]) VALUES (1028, N'pepe grillo en casa', 2342343, N'calle la misma', N'2342353', N'asdas@sad.com', CAST(N'2020-11-07T19:14:28.200' AS DateTime), N'javier')
...
INSERT [dbo].[TBLPRODUCTO] ([IdProducto], [StrNombre], [StrCodigo], [NumPrecioCompra], [NumPrecioVenta], [IdCategoria], [StrDetalle], [strFoto], [NumStock], [DtmFechaModifica], [StrUsuarioModifico]) VALUES (2, N'TECLADOS BLUETOOTH STANDAR ', N'0065400', 35600, 210000, 2, N'nuevo de fabrica2', N'ninguna', 4, CAST(N'2021-03-12T00:00:00.000' AS DateTime), N'Javier')
...
INSERT [dbo].[TBLPRODUCTO] ([IdProducto], [StrNombre], [StrCodigo], [NumPrecioCompra], [NumPrecioVenta], [IdCategoria], [StrDetalle], [strFoto], [NumStock], [DtmFechaModifica], [StrUsuarioModifico]) VALUES (5, N'televisor led 54 pulgadas ', N'234444', 2000000, 3000000, 1, N'es un excelente producto', N'c:', 5, CAST(N'2021-03-15T00:00:00.000' AS DateTime), N'Javier')
